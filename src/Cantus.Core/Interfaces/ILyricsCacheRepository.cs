...
public interface ILyricsCacheRepository
{
    ...
    Task MarkNotFoundAsync(string trackId, string trackName, string artistName, string albumName, int durationMs, TimeSpan timeToLive, CancellationToken cancellationToken = default);
